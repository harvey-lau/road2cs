# This .py file shows an example of how to break things with random inputs (fuzz),
# which references [Fuzzing: Breaking Things with Random Inputs](https://www.fuzzingbook.org/html/Fuzzer.html)
